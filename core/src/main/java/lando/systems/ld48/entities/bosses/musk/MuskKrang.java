...
public class MuskKrang extends Boss {
    ...
    static class Animations {
        ...
        public Animation<TextureRegion> shootA;
        public Animation<TextureRegion> shootB;
        public Animation<TextureRegion> missileA;
        public Animation<TextureRegion> missileB;
    }

    public MuskKrang(GameScreen screen, float x, float y) {
        this.animations = new Animations();
        this.animations.idleA   = screen.game.assets.muskIdleAAnimation;
        this.animations.idleB   = screen.game.assets.muskIdleBAnimation;
        this.animations.shootA   = screen.game.assets.muskShootAAnimation;
        this.animations.shootB = screen.game.assets.muskShootBAnimation;
        this.animations.missileA   = screen.game.assets.muskMissileAAnimation;
        this.animations.missileB   = screen.game.assets.muskMissileBAnimation;
    ...
    static class Missile {
        ...
        public Missile(MuskKrang muskKrang, Animation<TextureRegion> missile, float velX, float velY) {
            bounds.set(muskKrang.position.x + 90, muskKrang.position.y + 55, 22f);
