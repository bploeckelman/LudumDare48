...
public class SpawnInteractable {
    ...
    public SpawnInteractable(SpawnInteractable.Type type, float x, float y, Assets assets) {
        this.type = type;
    ...
    public void spawn(GameScreen screen) {
        ...
        InteractableEntity entity = new InteractableEntity(screen, pos.x, pos.y, type, anim);
